...
public class CreateFriend extends AppCompatActivity {
    ...
    public void onSaveClick(View view) {
        // Write the function to save the friend's details to the file "friends.dat".
        // If a friend is successfully saved, end this activity otherwise show a Toast with an error.
